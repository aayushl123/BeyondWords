...
public class CountryAdapter extends RecyclerView.Adapter<CountryAdapter.SingleViewHolder> implements Filterable {
    ...
    public CountryAdapter(Context context, ArrayList<String> options, ViewPager viewPager) {
        this.context = context;
        this.options = options;
        this.viewPager=viewPager;
    }

    public CountryAdapter(Context context, ArrayList<String> options) {
        this.context = context;
        this.options = options;
        ...
        void bind(final String option) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    PersonInfo.getInstance().setmCountry(textView.getText().toString());
