...
public class CitizenshipAdapter extends RecyclerView.Adapter<CitizenshipAdapter.SingleViewHolder> implements Filterable {
    ...
    public CitizenshipAdapter(Context context, ArrayList<String> options, ViewPager viewPager) {
        this.context = context;
        this.options = options;
        this.viewPager=viewPager;
    }

    public CitizenshipAdapter(Context context, ArrayList<String> options) {
        this.context = context;
        this.options = options;
        ...
        void bind(final String option) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    PersonInfo.getInstance().setmCitizenShip(textView.getText().toString());
