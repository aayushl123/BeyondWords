...
public class LanguageAdapter extends RecyclerView.Adapter<LanguageAdapter.SingleViewHolder> implements Filterable {
    ...
    public LanguageAdapter(Context context, ArrayList<String> options, ViewPager viewPager) {
        this.context = context;
        this.options = options;
        this.viewPager=viewPager;
    }

    public LanguageAdapter(Context context, ArrayList<String> options) {
        this.context = context;
        this.options = options;
        ...
        void bind(final String option) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    PersonInfo.getInstance().setmLanguage(textView.getText().toString());
