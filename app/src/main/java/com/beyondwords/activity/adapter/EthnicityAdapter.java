...
public class EthnicityAdapter extends RecyclerView.Adapter<EthnicityAdapter.SingleViewHolder> implements Filterable {
    ...
    public EthnicityAdapter(Context context, ArrayList<String> options, ViewPager viewPager) {
        this.context = context;
        this.options = options;
        this.viewPager=viewPager;
    }

    public EthnicityAdapter(Context context, ArrayList<String> options) {
        this.context = context;
        this.options = options;
        ...
        void bind(final String option) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    PersonInfo.getInstance().setmEthnicity(textView.getText().toString());
