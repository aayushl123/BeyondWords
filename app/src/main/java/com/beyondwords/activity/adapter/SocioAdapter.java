...
public class SocioAdapter extends RecyclerView.Adapter<SocioAdapter.SingleViewHolder> implements Filterable {
    ...
    public SocioAdapter(Context context, ArrayList<String> options, ViewPager viewPager) {
        this.context = context;
        this.options = options;
        this.viewPager=viewPager;
    }

    public SocioAdapter(Context context, ArrayList<String> options) {
        this.context = context;
        this.options = options;
        ...
        void bind(final String option) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    PersonInfo.getInstance().setmSocio(textView.getText().toString());
